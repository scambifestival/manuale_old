...
* ****[**blog.scambi.org**](https://blog.scambi.org) è il nostro blog basato su Wordpress, a cui si accede da [qui](https://blog.scambi.org/wp-admin). La creazione e la pubblicazione di ogni articolo sono coordinate dalle [Chiocciole](<../../README (1).md#chiocciole>).
...
* **Telegram** è mezzo di comunicazione principale. TUTTE le comunicazioni relative a Scambi hanno luogo su questa piattaforma. I gruppi principali sono:
  ...
  * Ogni [team](<../../README (1).md>) ha il proprio gruppo specifico
...
* ****[**Canva**](https://canva.com) è lo strumento utilizzato principalmente dalle [Libellule](<../../README (1).md#libellule>) per creare le grafiche dei nostri post. Utilizziamo Canva Premium, perciò se dedideri avere l’accesso fatti inviare un link dai membri del team.
...
Per qualunque problema tecnico, compilare immediatamente [questo modulo](https://nuvola.scambi.org/apps/forms/qtqRxnSic6fTpmKk) e contattare il gruppo [Silicon](<../../README (1).md#silicon>).
